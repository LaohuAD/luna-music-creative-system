...
- `高价值信息`：主风格、情绪主轴、节奏、演唱姿态、核心编曲、关键音色、高潮组织、avoid/exclude
- `低价值信息`：重复修饰词、审美空词、互相打架的标签、只是好看但没有控制力的描述
...
- 把 `avoid glossy pop polish` 改成 `allow polished pop finish`，会更主流、更商业
